...
| Code                      | Treatment                                                                                                                                                                                                                                                                                      |
| ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `capacity_unavailable`    | "Those seats have just gone." **`details.remaining` has what is left: offer it.** Checkout refetches the dates and shows the API's sentence above the calendar. No retry.                                                                                                                      |
| `price_moved`             | `expectedTotalMinor` no longer matches what the departure costs (yuvoy-api#193). "The price has changed": nothing held, nothing charged. Checkout refetches the dates, the bar shows the new total, and the next attempt is a new body under a new idempotency key. No retry of the old total. |
