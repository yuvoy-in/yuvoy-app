 ...
 *
 * It has happened twice. This app lost three production deploys to the
 * placeholder on 1 Sep 2026. On 24 Sep yuvoy.in was found starting PostHog
 * with "[SENSITIVE]" as its key: a consent banner, a privacy page saying
 * analytics run, and not one event recorded. The quiet case is the worst one
 * here: `NEXT_PUBLIC_INVITE_ONLY` arriving as the placeholder never says
 * "true", so the invite gate would stay off with every screen looking fine.
 *
